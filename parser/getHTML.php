...
// ---------- НАСТРОЙКИ ----------
$baseUrl = 'https://top.mail.ru/Rating/Cars/Today/Visitors/';   // Базовый URL (без номера страницы)
$start = 1;                           // Начальная страница
$end = 100;                            // Конечная страница
$folder = 'topmailavto';          // Папка для сохранения файлов
// --------------------------------
